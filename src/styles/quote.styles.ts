...
export const invoiceStyles = StyleSheet.create({
  ...
  assistantRowTitle: { fontSize: 12, fontWeight: '800', color: '#111827' },
  assistantRowDesc: { fontSize: 11, fontWeight: '600', color: '#64748B', marginTop: 2 },
  assistantCta: { fontSize: 11, fontWeight: '800' },
  ...
  pipelineLabel: { fontSize: 10, fontWeight: '700', color: '#64748B' },
  pipelineBar: { height: 4, borderRadius: 999, marginTop: 4 },
  ...
  detailAmount: { fontSize: 40, fontWeight: '700', color: '#D97706', textAlign: 'center' },
  ...
  attachmentName: { fontSize: 13, fontWeight: '600', color: '#1F2937' },
  attachmentSub: { fontSize: 11, color: '#D97706', marginTop: 2 },
  attachmentDownload: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  detailDownloadPdfText: { fontSize: 14, fontWeight: '600', color: '#D97706' },
  inlineDeleteBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  // Detail row left icon+label group
  detailRowLeft: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
