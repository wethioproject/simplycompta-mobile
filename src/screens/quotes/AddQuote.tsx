...
const AddQuote: React.FC = ({ navigation }: any) => {
    ...
    const filteredDueDateOptions = dueDateOptions.filter(option =>
        option.toLowerCase().includes(dueDateSearchQuery.toLowerCase())
    );

    const filteredClientDataOptions = clientDataOptions.filter(option =>
    ...
    const filteredPaymentModeOptions = paymentModeOptions.filter(option =>
    ...
    const filteredDeviseOptions = deviseOptions.filter(option =>
    ...
    const handleAddClient = () => {
        ...
        // You would typically add this to your client list state
    ...
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Ajouter devis</Text>
            ...
            >
                ...
                <View style={styles.section}>
                    <Text style={styles.label}>
                        Durée de validité <Text style={styles.required}>*</Text>
                    </Text>
                    <TextInput
                        style={styles.input}
            ...
            {/* Devise Type Modal */}
            <Modal
                visible={showDeviseTypeModal}
                transparent={false}
                animationType="slide"
                onRequestClose={() => setShowDeviseTypeModal(false)}
            >
                <View
                    style={[
                        styles.modalOverlayFullscreen,
                ...
                >
                    ...
                    <View style={styles.modalContentFullscreen}>
                        <View style={styles.modalHeaderFullscreen}>
                            ...
                            <Text style={styles.modalTitleFullscreen}>Type</Text>
                            <View style={styles.placeholder} />
                        </View>

                        <ScrollView style={styles.optionsList} showsVerticalScrollIndicator={false}>
                            {['Gauche', 'Droite'].map((option, index) => (
                                <TouchableOpacity
                                    key={index}
                                    style={styles.optionItem}
                                    onPress={() => {
                                        setDeviseType(option);
                                        setShowDeviseTypeModal(false);
                                        setTimeout(() => {
                                            setShowAddDeviseModal(true);
                                        }, 300);
                    ...
                    <View style={styles.modalContentFullscreen}>
                        ...
                        >
                            ...
                            <View style={styles.formSection}>
                                ...
                                <Dropdown
                                    style={styles.dropdown}
                                    data={countryOptions.map(country => ({ label: country, value: country }))}
                                    labelField="label"
                                    valueField="value"
                ...
                >
                    ...
                    <View style={styles.modalContentFullscreen}>
                        <View style={styles.modalHeaderFullscreen}>
                            ...
                            <Text style={styles.modalTitleFullscreen}>Sélectionner un pays</Text>
                            <View style={styles.placeholder} />
                        </View>
