...
interface AddDeliveryNoteProps {
...
const AddDeliveryNote: React.FC<AddDeliveryNoteProps> = ({ navigation }) => {
    ...
    const [tempDeliveryDate, setTempDeliveryDate] = useState(new Date(2026, 0, 29));
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Ajouter bon de livraison</Text>
            ...
            >
                ...
                <View style={styles.section}>
                    <Text style={styles.label}>
                        Date de livraison <Text style={styles.required}>*</Text>
                    </Text>
                    <TouchableOpacity
                        style={styles.inputWithIcon}
                        onPress={() => {
                            setTempDeliveryDate(deliveryDate);
                    ...
                    <View style={styles.modalOverlay}>
                        <View style={styles.modalContent}>
                            <View style={styles.modalHeader}>
                                ...
                                <Text style={styles.modalTitle}>Date de livraison</Text>
                                <TouchableOpacity
                                    onPress={() => {
