...
type TabType = 'Tous' | 'Brouillon' | 'Validé' | 'Livré' | 'Facturé';

const DeliveryNotes: React.FC = ({ navigation }: any) => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <TouchableOpacity
          style={styles.tab}
          onPress={() => setActiveTab('Livré')}
        >
          <Text
            style={[
              styles.tabText,
              activeTab === 'Livré' && styles.activeTabText,
            ]}
          >
            Livré
          </Text>
          {activeTab === 'Livré' && <View style={styles.tabIndicator} />}
        </TouchableOpacity>
      ...
      {/* FAB Button */}
        <TouchableOpacity style={styles.fab} onPress={() => navigation.navigate('Add Delivery Note')}>
