...
const Payments: React.FC = ({ navigation }: any) => {
  ...
  const handleInvoicePress = (invoice: any) => {
    navigation.navigate('Edit Payments', { payment: invoice });
  };
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Règlements</Text>
      ...
      {/* FAB Button */}
        <TouchableOpacity style={styles.fab} onPress={()=> navigation.navigate('Add Regulation')}>
